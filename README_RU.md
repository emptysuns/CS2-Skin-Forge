...
Для наилучшего опыта игры с ботами мы рекомендуем использовать [CS2-Bot-Improver](https://github.com/ed0ard/CS2-Bot-Improver) вместе с этим плагином.

> **Совет:** Рекомендуем сначала установить CS2-Bot-Improver — он также автоматически развернёт фреймворк CounterStrikeSharp. Затем установите наш скиновый плагин — он обнаружит уже установленный CounterStrikeSharp и развернёт только свои файлы мода.
